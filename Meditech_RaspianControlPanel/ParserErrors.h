...
\brief Defines the parser error codes.
 ...
 These error codes are returned by the ChipKit board after parsing a command
 sent from the master. Else a command OK is returned for every sent parameter.
  */
...
//! This message occurs when the parameters following a command are wrong,
...
#define COMMAND_WRONG_TEMPLATE 10

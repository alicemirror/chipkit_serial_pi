...
\brief Constants and types used to manage the command parsing and data exchange
with the ChipKit control panel board.

Defines the constants and structures used by the to process the requests and 
exchange data through the serial connection with the control panel board.
  */
...
/**
  ...
  series of parameters. Every one of them should include a field separator character.
  */
